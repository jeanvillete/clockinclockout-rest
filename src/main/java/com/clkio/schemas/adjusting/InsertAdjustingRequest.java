...
/**
 * <p>Java class for insertAdjustingRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="insertAdjustingRequest">
 *   &lt;complexContent>
...
@XmlType(name = "insertAdjustingRequest", propOrder = {
    "adjusting"
})
public class InsertAdjustingRequest {

    @XmlElement(required = true)
    protected Adjusting adjusting;

    public InsertAdjustingRequest() {
    	super();
    }
    
    public InsertAdjustingRequest( Adjusting adjusting ) {
		super();
